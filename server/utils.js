...
class Utils {
    ...
    static saveJson(filename, data) {
        try {
            ...
            console.error(`An error occured while trying writing to ${filename}`, error.message)
        }
    }
    static readJson(filename) {
        try {
            ...
            console.error(`An error occured while trying reading from ${filename}`, error.message)
        }
